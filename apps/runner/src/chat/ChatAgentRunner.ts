...
export class ChatAgentRunner {
  ...
  private buildInstructions(): string {
    ...
    return [
      ...
      "- **Password/OTP prompts**: Ask user conversationally to type the secret in the browser; never request the code in chat",
  ...
  private getGoogleAccountInstructions(): string {
    ...
    return [
      ...
      "",
      "### OTP / 2FA Challenge",
      "- Say conversationally: 'Google needs a verification code. Could you enter it in the browser? I'll continue right after.'",
      "- Never ask the user to paste OTP, password, passkey, or recovery codes into chat",
      "",
